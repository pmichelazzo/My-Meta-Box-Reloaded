/**
 * Easy WP Meta Box Class JS
 *
 * JS used for meta boxes and form items.
 *
 * Copyright© 2021 Paulino Michelazzo (michelazzo@me.com)
 */
...
jQuery(document).ready(function($) {
  ...
  $(window).resize( function() {
    $.each(Ed_array, function() {
      ...
      $(ee.getScrollerElement()).width(width);
      ee.refresh();
    });
  });
});
...
var _metabox_fields = {
  ...
  init: function() {
    ...
    $('#add-conc_re_').on('click', function() {
      alert(gid);
    });
  },
...
window.setTimeout('_metabox_fields.init();', 500);
